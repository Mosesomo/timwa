              ...
              <div className="mb-8">
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    ...
                    style={{ background: "#1877F2", boxShadow: "0 4px 12px rgba(24,119,242,0.35)" }}
                  >
                  ...
                  {/* TikTok — black bg, red+teal brand paths */}
                  <a
                    ...
                    style={{ background: "#010101", boxShadow: "0 4px 12px rgba(0,0,0,0.4)" }}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                      ...
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.3 0 .59.05.88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" fill="#69C9D0" opacity="0.55"/>
                    </svg>
                  </a>
